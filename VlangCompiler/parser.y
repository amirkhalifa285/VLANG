...
int_list
    ...
    | int_list COMMA INT
        { char *b=(char*)malloc(strlen($1)+32); sprintf(b,"%s,%d",$1,$3); free($1); $$=b; }
    ;
    ...
    | expression PLUS expression
        {
            ...
            if (l && r) {                                   /* v + v */
                ...
                char *code = (char*)malloc(strlen($1.code)+strlen($3.code)+4);
...
| expression DIVIDE expression
{
    ...
    | LPAREN expression RPAREN
        {
            char *code = (char*)malloc(strlen($2.code)+3);
  ...
  | expression DOTPROD expression
{
    ...
    char *code = (char*)malloc(strlen($1.code)+strlen($3.code)+32);
   ...
   | LBRACK int_list RBRACK       /* literal vector */
    ...
    {
        $$.setup = cat2($1.setup, $3.setup);
        char *code = (char*)malloc(strlen($1.code)+strlen($3.code)+6);
        sprintf(code, "%s == %s", $1.code, $3.code);
        $$.code = code;
